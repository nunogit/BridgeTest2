...
public class DataSourceTxt 
{
	...
	{
		if(fields.length==0) throw new IOException("Fields is empty");
		if(fields.length<2) throw new IOException("Fields contains only one element: "+fields[0]);
